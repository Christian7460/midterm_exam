    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-2"></div>
                ...
                <div style="margin-left: 490px;" class="fb-page" 
                ...
                <div class="mapouter">
                    <div class="gmap_canvas"><iframe width="718" height="580" id="gmap_canvas" 
                    src="https://maps.google.com/maps?q=Saint%20Francis%20of%20Assisi%20College%20Bacoor&t=k&z=15&ie=UTF8&iwloc=&output=embed" 
                    frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://fmovies-online.net">
                        fmovies</a><br><style>.mapouter{position:relative;text-align:right; margin-left: 390px; height:580px;width:718px;}</style>
                        <a href="https://www.embedgooglemap.net">embed google maps in website</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:580px;width:718px;}</style>
                    </div>
                </div>
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v13.0" nonce="c5lVlLf8"></script>
